...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aF, request.aV, true);
		} catch (e) {
...
var $author$project$PageDataModel$Close = 1;
var $author$project$Actions$GotMonsters = function (a) {
	return {$: 0, a: a};
};
var $author$project$PageDataModel$Loading = {$: 0};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{as: false, au: r.au, ay: r.ay, S: r.S, aF: r.aF, aS: r.aS, am: r.am, aV: r.aV}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{au: $elm$http$Http$emptyBody, ay: r.ay, S: _List_Nil, aF: 'GET', aS: $elm$core$Maybe$Nothing, am: $elm$core$Maybe$Nothing, aV: r.aV});
};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Models$Monster = F5(
	function (id, name, pow, lif, spd) {
		return {aB: id, aE: lif, aG: name, aK: pow, aO: spd};
	});
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map5 = _Json_map5;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Decoders$monsterDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Models$Monster,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'pow', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'lif', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'spd', $elm$json$Json$Decode$int));
var $author$project$Decoders$monsterListDecoder = A2(
	$elm$json$Json$Decode$field,
	'monsters',
	$elm$json$Json$Decode$list($author$project$Decoders$monsterDecoder));
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{F: 1, G: $author$project$PageDataModel$Loading},
		$elm$http$Http$get(
			{
				ay: A2($elm$http$Http$expectJson, $author$project$Actions$GotMonsters, $author$project$Decoders$monsterListDecoder),
				aV: 'src/mocks/monsters.json'
			}));
};
...
var $author$project$PageDataModel$Failure = {$: 1};
var $author$project$PageDataModel$Open = 0;
var $author$project$PageDataModel$Success = function (a) {
	return {$: 2, a: a};
};
	...
	function (message, model) {
		switch (message.$) {
			case 0:
				...
				if (!result.$) {
					var monsters = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								G: $author$project$PageDataModel$Success(monsters)
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{G: $author$project$PageDataModel$Failure}),
						$elm$core$Platform$Cmd$none);
				}
			case 1:
				return _Utils_Tuple2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'padding', '40px 0')
			]),
		children);
};
var $author$project$Actions$CloseModal = {$: 2};
var $author$project$Views$StyledViews$modal = function (children) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background-color', 'rgba(100,100,100,0.5)'),
				A2($elm$html$Html$Attributes$style, 'z-index', '999999'),
				A2($elm$html$Html$Attributes$style, 'display', 'flex'),
				A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
				A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
				$elm$html$Html$Events$onClick($author$project$Actions$CloseModal)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Views$StyledViews$flexContainer = function (children) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Views$StyledViews$card = function (children) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Views$GeneralViews$monsterCardContainer = function (mons) {
	switch (mons.$) {
		...
		default:
			var monsters = mons.a;
			return $author$project$Views$StyledViews$flexContainer(
				A2($elm$core$List$map, $author$project$Views$GeneralViews$monsterCard, monsters));
	}
};
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$Views$StyledViews$badMessage = function (message) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$Views$StyledViews$goodMessage = function (message) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$Views$GeneralViews$monstersCount = function (model) {
	var _v0 = model.G;
	switch (_v0.$) {
		case 0:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Still loading...')
					]));
		case 1:
			return $author$project$Views$StyledViews$badMessage('There was a problem getting the monsters');
		default:
			var monsters = _v0.a;
			return $author$project$Views$StyledViews$goodMessage(
	...
	return $author$project$Views$StyledViews$container(
		_List_fromArray(
			[
				...
				var _v0 = model.F;
				if (!_v0) {
					return $author$project$Views$StyledViews$modal(
						_List_fromArray(
							[
								$elm$html$Html$text('testing modal')
							]));
				} else {
					return $elm$html$Html$text('');
				}
...
var $author$project$Main$view = function (model) {
	return $author$project$Views$MainView$mainView(model);
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aD: $author$project$Main$init, aR: $author$project$Main$subscriptions, aU: $author$project$Main$update, aW: $author$project$Main$view});
